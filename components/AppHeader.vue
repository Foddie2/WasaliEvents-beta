<template>
  <nav
    class="site-header max-w-6xl mx-auto  relative w-full flex flex-wrap items-center justify-between py-4 bg-gray-100 text-gray-500 hover:text-gray-700 focus:text-gray-700 shadow-lg navbar navbar-expand-lg navbar-light"
  >
    <div
...
<style scoped>
.site-header {
  @apply sticky top-0 w-full p-4 bg-slate-100 bg-opacity-10 border-b-2 border-white border-opacity-30 backdrop-blur-lg z-20;
}
</style>
